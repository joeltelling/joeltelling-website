      ...
      <section id="projects" className="scroll-mt-8 px-6 py-16 sm:px-8 lg:px-12">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-5">
            ...
            {/* Technically Nerdy */}
            <div className="card-hover md:col-span-2 flex flex-col justify-between rounded-2xl border border-accent-green/20 bg-gradient-to-br from-accent-green/10 to-bg-surface p-7">
              <div>
                <span className="mb-4 inline-block rounded-full bg-accent-green/20 px-3 py-1 font-mono text-[10px] font-bold uppercase tracking-widest text-accent-green">
                  YouTube
                </span>
                <h3 className="mb-1 font-heading text-2xl text-white">Technically Nerdy</h3>
                <p className="text-sm leading-relaxed text-slate-400">
                  Tech beyond 3D printing. Gadgets, apps, software, and everything else that makes a nerd tick.
                </p>
              </div>
              <div className="mt-5 flex flex-wrap items-center gap-3">
                <a
                  href="https://youtube.com/@technicallynerdy"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 rounded-lg bg-accent-red px-4 py-2 text-sm font-semibold text-white transition-all hover:brightness-110 cursor-pointer"
                >
                  <YouTubeIcon className="w-4 h-4" />
                  Watch on YouTube
                </a>
          ...
          {/* Bento Row 2: SOLVD + Orange Banana + Ball Speed + RMRF */}
          <div className="mt-5 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="card-hover flex flex-col justify-between rounded-2xl border border-border-subtle bg-bg-surface p-7">
              <div>
                <Image src="/solvd-icon.png" alt="SOLVD" width={44} height={44} className="mb-3 rounded-xl" />
                <h3 className="mb-1 font-heading text-xl text-white">SOLVD</h3>
                <p className="text-sm leading-relaxed text-slate-400">
            ...
            <div className="card-hover flex flex-col justify-between rounded-2xl border border-accent-amber/20 bg-gradient-to-br from-accent-amber/10 to-bg-surface p-7">
              ...
              <div className="mt-4">
                ...
                <Link
                  href="/orangebanana/beta"
                  className="mt-3 inline-flex items-center gap-2 rounded-lg bg-accent-green px-4 py-2 text-xs font-semibold text-white transition-all hover:brightness-110 cursor-pointer"
                >
                  <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4" aria-hidden="true">
                    <path d="M6 18c0 .55.45 1 1 1h1v3.5c0 .83.67 1.5 1.5 1.5s1.5-.67 1.5-1.5V19h2v3.5c0 .83.67 1.5 1.5 1.5s1.5-.67 1.5-1.5V19h1c.55 0 1-.45 1-1V8H6v10zM3.5 8C2.67 8 2 8.67 2 9.5v7c0 .83.67 1.5 1.5 1.5S5 17.33 5 16.5v-7C5 8.67 4.33 8 3.5 8zm17 0c-.83 0-1.5.67-1.5 1.5v7c0 .83.67 1.5 1.5 1.5s1.5-.67 1.5-1.5v-7c0-.83-.67-1.5-1.5-1.5zm-4.97-5.84l1.3-1.3c.2-.2.2-.51 0-.71-.2-.2-.51-.2-.71 0l-1.48 1.48A5.84 5.84 0 0 0 12 1c-.96 0-1.86.23-2.66.63L7.85.15c-.2-.2-.51-.2-.71 0-.2.2-.2.51 0 .71l1.31 1.31A5.983 5.983 0 0 0 6 7h12c0-2.21-1.2-4.15-2.97-5.18-.07-.05-.14-.1-.22-.14l.22-.52zM10 5H9V4h1v1zm5 0h-1V4h1v1z" />
                  </svg>
                  Android Beta Test
                </Link>
              </div>
